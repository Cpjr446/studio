...
export default function WhyChooseSection() {
  return (
    <section id="why-choose-us" className="py-20 md:py-28 bg-background dark:bg-slate-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
          {benefits.map((benefit) => (
            <Card key={benefit.title} className="bg-card dark:bg-dark-card dark:border-slate-600 rounded-xl shadow-lg hover:shadow-xl dark:hover:shadow-primary/20 transition-shadow duration-300 p-6 flex flex-col items-center text-center md:flex-row md:text-left md:items-start md:space-x-6">
