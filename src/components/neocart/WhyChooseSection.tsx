...
export default function WhyChooseSection() {
  return (
    <section id="why-choose-us" className="py-20 md:py-28 bg-slate-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900">Why SmartOrder is Your Best Choice</h2>
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
          {benefits.map((benefit) => (
            <Card key={benefit.title} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 flex flex-col items-center text-center md:flex-row md:text-left md:items-start md:space-x-6">
              <div className="flex-shrink-0 mb-4 md:mb-0 p-3 bg-primary/10 rounded-full">
                {benefit.icon}
              </div>
              <div>
                <CardTitle className="text-xl font-semibold text-slate-800 mb-2">{benefit.title}</CardTitle>
        ...
        <div className="mt-16 text-center">
            <h3 className="text-2xl font-semibold text-slate-800 mb-4">Ready to Transform Your Operations?</h3>
            <p className="text-slate-600 mb-8 max-w-xl mx-auto">
                Join hundreds of businesses leveraging SmartOrder to achieve new heights of e-commerce success.
            </p>
            <a
                href="#contact"
                className="inline-block px-10 py-3 bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-primary/90 transition-colors text-lg"
            >
